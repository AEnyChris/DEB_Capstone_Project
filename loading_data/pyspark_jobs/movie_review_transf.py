...
output_mv_df = stop_words_removed_mv_df.withColumns({
    "is_positive": is_positive_udf(stop_words_removed_mv_df["stop_words_removed"]),
    "insert_date": F.lit(datetime.now())
})
